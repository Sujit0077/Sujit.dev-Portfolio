        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-left">
            ...
            <p className="text-muted-foreground text-justify">
              Hi, I&apos;m Sujit. I&apos;m a software engineer with a strong
              focus on full-stack web development. My expertise spans across
              frontend technologies like React and Tailwind CSS, along with
              backend technologies such as Node.js and Express. With a degree in
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
              ...
              <a
                href="/public/Sujit_Gupta_Developer.pdf"
